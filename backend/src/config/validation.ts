...
export const validationSchema = Joi.object({
  ...
  WX_PAY_APPID: Joi.string().allow('').default(''),
  WX_PAY_MCH_ID: Joi.string().allow('').default(''),
  WX_PAY_API_KEY: Joi.string().allow('').default(''),
  WX_PAY_API_V3_KEY: Joi.string().allow('').default(''),
  WX_PAY_CERT_SERIAL_NO: Joi.string().allow('').default(''),
  WX_PAY_PRIVATE_KEY_PATH: Joi.string().allow('').default(''),
  WX_PAY_PLATFORM_CERT_PATH: Joi.string().allow('').default(''),
  WX_PAY_NOTIFY_URL: Joi.string().allow('').default(''),
  WECHAT_APPID: Joi.string().allow('').default(''),
  PAY_MCHID: Joi.string().allow('').default(''),
  PAY_KEY_V3: Joi.string().allow('').default(''),
  PAY_KEY_V2: Joi.string().allow('').default(''),
  PAY_SERIAL: Joi.string().allow('').default(''),
  PAY_CERT_PATH: Joi.string().allow('').default(''),
  PAY_KEY_PATH: Joi.string().allow('').default(''),
  PAY_PLATFORM_CERT_PATH: Joi.string().allow('').default(''),
  PAY_PREFIX: Joi.string().allow('').default(''),
