...
function goTasks() { uni.navigateTo({ url: '/pages/foster/tasks/index' }); }
function goPigs() { uni.navigateTo({ url: '/pages/foster/pigs/index' }); }
function goEarnings() { uni.navigateTo({ url: '/pages/foster/earnings/index' }); }
